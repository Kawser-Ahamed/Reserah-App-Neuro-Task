...
import 'package:research_app/backend/memory_game_backend.dart';
                ...
                Row(
                  ...
                  children: [
                    TextButton(
                     ...
                     TextButton(
                      onPressed: (){
                        //Backend Fuction Call
                        try{
                        MemoryGameBackend().firstFlip(firstFlipTime);
                        MemoryGameBackend().sequence(sequence);
                        MemoryGameBackend().timeGap(timeGap);
                        MemoryGameBackend().individualFlip(card1,card2,card3,card4,card5,card6,card7,card8,card9,card10,card11,card12);
                        MemoryGameBackend().sucess(sucessFlip, sucessTime);  
                        }
                        catch(e){
                          // Navigator.popAndPushNamed(context, MyRoute.homePage);
                        } 
                        Navigator.popAndPushNamed(context, MyRoute.homePage);
                     },
